...
storageDir="/eos/user/r/rsaradhy/HiggsCouplings/Trees_2024_03_08_lhcpCats"
outDir=$1
if [[ -z $outDir ]]; then
    echo "usage: $0 <outDir>"
    exit -1
