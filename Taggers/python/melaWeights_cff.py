...
melaWeights = cms.EDProducer("MELAGenMatrixElementWeightsProducer",
...
def addMelaWeights_ACJHU(process,mode,year):

    # =================================================================================================
    # ================================== ANOMALOUS COUPLINGS POINTS ===================================
    # =================================================================================================
    ### AC fa_i(s) ###
    # values from https://twiki.cern.ch/twiki/bin/view/CMS/Run2MC2017ProductionforHiggsProperties
    JHU_points = ["Name:SM Couplings:ghz1=1,0;ghw1=1,0",
                  "Name:h0ph Couplings:ghz1=0,0;ghw1=0,0;ghz2=1,0",          # fa2=1 (0PH)
                  "Name:h0ph_f05 Couplings:ghz1=1,0;ghw1=1,0;ghz2=0.2720,0", # fa2=0.5 (0PHf05)
                  "Name:ghz2 Couplings:ghz1=1,0;ghw1=1,0;ghz2=1,0",         # fa2 term
                  ...
                  "Name:h0m Couplings:ghz1=0,0;ghw1=0,0;ghz4=1,0",             # fa3=1 (0M)
                  "Name:h0m_f05 Couplings:ghz1=1,0;ghw1=0,0;ghz4=0.2980,0",    # fa3=0.5 (0Mf05)
                  "Name:ghz4 Couplings:ghz1=1,0;ghw1=1,0;ghz4=1,0",            # fa3 term 
                  ...
                  "Name:h0l1 Couplings:ghz1=0,0;ghw1=0,0;ghz1_prime2=1,0",                  # fL1=1
                  "Name:h0l1_f05_prime2 Couplings:ghz1=1,0;ghw1=1,0;ghz1_prime2=-2158,0",   # fL1^VBF=0.5
                  "Name:h0l1zg Couplings:ghz1=0,0;ghw1=0,0;ghzgs1_prime2=1,0",              # fL1^Zg=1
                  "Name:hol1zg_f05 Couplings:ghz1=1,0;ghw1=1,0;ghzgs1_prime2=-4091,0",      # fL1^Zg=0.5
              ]
    
    process.melaGenMatrixElementWeightsJHU = melaWeights.clone(name = "MEWeight_prodJHUGen", 
                                                               mode = mode, year = year,
                                                               matrixElements = JHU_points)

    process.weightsAC = cms.Sequence(process.melaGenMatrixElementWeightsJHU)
    print "Anomalous couplings\n", "\n".join(JHU_points)


from MelaAnalytics.GenericMEComputer.couplingUtils import *

def addMelaWeights_EFT(process,bases):
    # ==================================================================================
    # ================================== HIGGS BASIS ===================================
    # ==================================================================================
    ...
    if bases in ("any", "Higgs"):
        ...
        process.melaGenMatrixElementHiggsWeights = melaWeights.clone(name = "MEWeight_Higgs", matrixElements = Higgs_SCAN)
        process.weightsHiggs = cms.Sequence(process.melaGenMatrixElementHiggsWeights)
    ...
    #process.melaGenMatrixElementHELWeights = melaWeights.clone( name = "MEWeight_HEL", matrixElements = HEL_SCAN)
    #process.melaGenMatrixElementHELEffWeights = melaWeights.clone( name = "MEWeight_HELEff", matrixElements = HELEff_SCAN)
    process.melaGenMatrixElementHELFlipWeights = melaWeights.clone( name = "MEWeight_HELFlip", matrixElements = HELFlip_SCAN)
    process.melaGenMatrixElementHELFlipEffWeights = melaWeights.clone( name = "MEWeight_HELFlipEff", matrixElements = HELFlipEff_SCAN)
    process.melaGenMatrixElementHELNoGWeights = melaWeights.clone( name = "MEWeight_HELNoG", matrixElements = HELNoG_SCAN)
    process.tablesHEL = cms.Sequence(
        #  process.melaGenMatrixElementHELWeights 
        #+ process.melaGenMatrixElementHELEffWeights 
        process.melaGenMatrixElementHELFlipWeights 
        + process.melaGenMatrixElementHELFlipEffWeights 
        + process.melaGenMatrixElementHELNoGWeights 
    )
    ...
    process.melaGenMatrixElementHELatNLONoGFixWeights   = melaWeights.clone( name = "MEWeight_HELatNLO_NoG_Fix", matrixElements = HELatNLO_NoG_fixBox_SCAN)
    #process.melaGenMatrixElementHELatNLONoGNoFixWeights = melaWeights.clone( name = "MEWeight_HELatNLO_NoG_NoFix", matrixElements = HELatNLO_NoG_noFixBox_SCAN) # BAD for cWbox in WH
    #process.melaGenMatrixElementHELatNLONoFlipFixWeights   = melaWeights.clone( name = "MEWeight_HELatNLO_NoFlip_Fix", matrixElements = HELatNLO_NoFlip_fixBox_SCAN)
    process.melaGenMatrixElementHELatNLOFlipZGFixWeights   = melaWeights.clone( name = "MEWeight_HELatNLO_FlipZG_Fix", matrixElements = HELatNLO_FlipZG_fixBox_SCAN)
    #process.melaGenMatrixElementHELatNLONoFlipNoFixWeights   = melaWeights.clone( name = "MEWeight_HELatNLO_NoFlip_NoFix", matrixElements = HELatNLO_NoFlip_noFixBox_SCAN)
    #process.melaGenMatrixElementHELatNLOFlipZGNoFixWeights   = melaWeights.clone( name = "MEWeight_HELatNLO_FlipZG_NoFix", matrixElements = HELatNLO_FlipZG_noFixBox_SCAN)
    process.melaGenMatrixElementHELatNLOFlipZGEffFixWeights   = melaWeights.clone( name = "MEWeight_HELatNLO_FlipZGEff_Fix", matrixElements = HELatNLO_FlipZGEff_fixBox_SCAN)
    #process.melaGenMatrixElementHELatNLOEffWeights = melaWeights.clone( name = "MEWeight_HELEff", matrixElements = HELEff_SCAN)
    #process.melaGenMatrixElementHELatNLOFlipWeights = melaWeights.clone( name = "MEWeight_HELFlip", matrixElements = HELFlip_SCAN)
    #process.melaGenMatrixElementHELatNLOFlipEffWeights = melaWeights.clone( name = "MEWeight_HELFlipEff", matrixElements = HELFlipEff_SCAN)
    #process.melaGenMatrixElementHELatNLONoGWeights = melaWeights.clone( name = "MEWeight_HELNoG", matrixElements = HELNoG_SCAN)
    process.tablesHELatNLO = cms.Sequence(
        process.melaGenMatrixElementHELatNLONoGFixWeights  +
        #process.melaGenMatrixElementHELatNLONoGNoFixWeights +
        #process.melaGenMatrixElementHELatNLONoFlipFixWeights +
        process.melaGenMatrixElementHELatNLOFlipZGFixWeights +
        #process.melaGenMatrixElementHELatNLONoFlipNoFixWeights +
        #process.melaGenMatrixElementHELatNLOFlipZGNoFixWeights +
        process.melaGenMatrixElementHELatNLOFlipZGEffFixWeights 
    )
    ...
    #process.melaGenMatrixElementWarWeights = melaWeights.clone( name = "MEWeight_War", matrixElements = War_SCAN)
    #process.melaGenMatrixElementWarEffWeights = melaWeights.clone( name = "MEWeight_WarEff", matrixElements = WarEff_SCAN)
    process.melaGenMatrixElementWarFlipWeights = melaWeights.clone( name = "MEWeight_WarFlip", matrixElements = WarFlip_SCAN)
    process.melaGenMatrixElementWarFlipEffWeights = melaWeights.clone( name = "MEWeight_WarFlipEff", matrixElements = WarFlipEff_SCAN)
    #process.melaGenMatrixElementWarFlipEffF1Weights = melaWeights.clone( name = "MEWeight_WarFlipEffF1", matrixElements = WarFlipEffF1_SCAN)
    #process.melaGenMatrixElementWarFlipEffF2Weights = melaWeights.clone( name = "MEWeight_WarFlipEffF2", matrixElements = WarFlipEffF2_SCAN)
    #process.melaGenMatrixElementWarFlipGGWeights = melaWeights.clone( name = "MEWeight_WarFlipGG", matrixElements = WarFlipGG_SCAN)
    #process.melaGenMatrixElementWarFlipGGEffWeights = melaWeights.clone( name = "MEWeight_WarFlipGGEff", matrixElements = WarFlipGGEff_SCAN)
    process.melaGenMatrixElementWarNoGWeights = melaWeights.clone( name = "MEWeight_WarNoG", matrixElements = WarNoG_SCAN)
    process.tablesWarsaw = cms.Sequence(
      #  process.melaGenMatrixElementWarWeights
      #  process.melaGenMatrixElementWarEffWeights +
        process.melaGenMatrixElementWarFlipWeights 
      + process.melaGenMatrixElementWarFlipEffWeights 
      #+ process.melaGenMatrixElementWarFlipEffF1Weights 
      #+ process.melaGenMatrixElementWarFlipEffF2Weights 
      #+ process.melaGenMatrixElementWarFlipGGWeights 
      #+ process.melaGenMatrixElementWarFlipGGEffWeights 
      + process.melaGenMatrixElementWarNoGWeights 
    )
    ...
    # # Decay
    # if "Decay" in melaWeights.mode.value():
    #     process.higgsDecayWeights = cms.EDProducer("HiggsDecayLevelVariablesProducer",
    #            genParticles = 'genParticles'
    #     )
    #     process.tables += process.higgsDecayWeights
